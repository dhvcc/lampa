let html = `<div>
    ...
    <div data-parent="internal_torrclient">
        <!-- PATCH START Add credentials for qBittorrent -->
        <div class="settings-param-title"><span>#{settings_qbittorrent_credentials}</span></div>

        <div class="settings-param selector" data-type="input" data-name="qbittorrent_user" placeholder="#{settings_parser_qbittorrent_user_placeholder}">
            <div class="settings-param__name">#{settings_qbittorrent_user}</div>
            <div class="settings-param__value"></div>
            <div class="settings-param__descr">#{settings_qbittorrent_user_descr}</div>
        </div>

        <div class="settings-param selector" data-type="input" data-name="qbittorrent_password" placeholder="#{settings_parser_qbittorrent_password_placeholder}">
            <div class="settings-param__name">#{settings_qbittorrent_password}</div>
            <div class="settings-param__value"></div>
            <div class="settings-param__descr">#{settings_qbittorrent_password_descr}</div>
        </div>
        <!-- PATCH END -->

        <!-- PATCH START Move settings header -->
